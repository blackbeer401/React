...
function Home(){
    ...
    // 수행과제  이미지가 있는 데이터를 목록으로 표기해보기
    //8) 대량의 데이터를 가진 배열 변수
    const [items2, setItems2]= useState([
        {no:1, name:'sam', message:'Hello react',image:'https://cdn.pixabay.com/photo/2019/03/21/03/38/flowers-4070174_1280.jpg'},
        {no:2, name:'robin', message:'nice to meet you',image:'https://cdn.pixabay.com/photo/2019/02/26/07/10/winter-4021281_1280.jpg'},
        {no:3, name:'hong', message:'have a good day',image:'https://cdn.pixabay.com/photo/2020/12/24/09/15/beach-5856896_1280.jpg'},
        {no:4, name:'park', message:'nice AI',image:'https://cdn.pixabay.com/photo/2020/12/24/09/15/beach-5856890_1280.jpg'},
    ])
